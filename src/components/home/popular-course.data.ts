...
export const data: Array<Course> = [
  {
    ...
    title: 'Coding Club',
    description:' is a place that brings people together, Unleash your digital creativity and join the CodeCrafters Collective. Dive into the world of programming, problem-solving, and innovation as we write lines of code that shape the future.',
  },
  {
    id: 2,
